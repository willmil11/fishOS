...
# Compile C kernel
gcc -ffreestanding -m64 -mno-red-zone -O3 -g -fno-omit-frame-pointer -fno-inline -fno-stack-protector -ffreestanding -nostdlib -fno-builtin -fno-builtin-memcpy  -fno-builtin-memset -fno-builtin-memmove -c fishOS.c -o fishOS.o
or begin
